        ...
        for line_number, line in enumerate(lines):
            ...
            if current_test_name:
                if '    ' in line or line.strip().startswith('def test_'):
                    ...
                    next_two_lines_are_empty = line_number<len(lines)-1 and not any([line, lines[line_number + 1].strip()])
